...
class SecondNotificationService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int
    {
        ...
        serviceHandler.post {
            ...
            //Here, we're counting down from 5 to 0 in the notification
    ...
    //A function to update the notification to display a count down from 5 to
    //0
    ...
    companion object {
        const val NOTIFICATION_ID = 0xCA8 // ID Notifikasi baru
        const val EXTRA_ID = "Id2" // Key baru untuk Intent Extra

        //this is a LiveData which is a data holder that automatically
        //updates the UI on what is observed
